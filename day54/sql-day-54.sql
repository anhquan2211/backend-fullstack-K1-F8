...
-- Dumping database structure for database_04_anhquan
CREATE DATABASE IF NOT EXISTS `database_04_anhquan` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `database_04_anhquan`;

-- Dumping structure for table database_04_anhquan.chi_tiet_su_dung_dv
...
-- Dumping data for table database_04_anhquan.chi_tiet_su_dung_dv: ~7 rows (approximately)

-- Dumping structure for table database_04_anhquan.dat_phong
...
-- Dumping data for table database_04_anhquan.dat_phong: ~4 rows (approximately)

-- Dumping structure for table database_04_anhquan.dich_vu_di_kem
...
-- Dumping data for table database_04_anhquan.dich_vu_di_kem: ~4 rows (approximately)

-- Dumping structure for table database_04_anhquan.khach_hang
...
-- Dumping data for table database_04_anhquan.khach_hang: ~4 rows (approximately)

-- Dumping structure for table database_04_anhquan.phong
